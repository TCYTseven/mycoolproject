    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            ...
            <span className="text-red-400">Computer Science</span>{" "}
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          {/* Welcome Section */}
          <div className="mb-16">
            <div className="bg-gradient-to-r from-red-500/10 to-transparent border-l-4 border-red-400 p-6 rounded-r-lg mb-8">
          ...
          <div className="mb-16">
            ...
            <div className="bg-gray-900/50 border border-red-500/20 rounded-lg p-6">
              <p className="text-xl text-gray-200">
                Every Thursday in Room 701 typically from <span className="text-red-400 font-semibold">2:30-4:00 PM</span>.
              </p>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-red-500/20 py-8 px-4 sm:px-6 lg:px-8">
