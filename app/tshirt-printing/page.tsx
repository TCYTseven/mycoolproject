      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            ...
            <span className="text-red-400">Printing</span>
          </h1>
          
          <div className="mt-12 space-y-8">
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-900/30 border border-red-500/20 rounded-lg p-8">
              <h2 className="text-2xl font-semibold mb-4 text-red-400">Custom Club T-Shirts</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                <div className="bg-black/50 border border-red-500/10 rounded-lg p-6">
            ...
            <div className="bg-gradient-to-r from-red-500/10 to-transparent border-l-4 border-red-400 p-6 rounded-r-lg">
              <p className="text-gray-200">
                <strong className="text-red-400">Note:</strong> T-shirt orders are typically processed during club meetings. 
