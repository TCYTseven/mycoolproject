...
export default function RidgeHacks() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-red-400">RidgeHacks</span>
          </h1>
          
          <div className="mt-12 space-y-8">
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-900/30 border border-red-500/20 rounded-lg p-8">
              <h2 className="text-2xl font-semibold mb-4 text-red-400">Annual Hackathon</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-r from-gray-900/50 to-gray-900/30 border border-red-500/20 rounded-lg p-6 hover:border-red-400/40 transition-all">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-red-400/20 rounded-lg flex items-center justify-center">
            ...
            <div className="bg-gradient-to-r from-red-500/10 to-transparent border-l-4 border-red-400 p-6 rounded-r-lg mt-8">
              <p className="text-gray-200">
                <strong className="text-red-400">Interested in participating?</strong> Contact club officers 
      ...
      <footer className="border-t border-red-500/20 py-8 px-4 sm:px-6 lg:px-8 mt-16">
